...
def runAllImageSimilaryFun(para1, para2):
    ...
    print("使用均值哈希算法得出的相似度: " + '%.2f%%' % ((1 - float(n1 / 64)) * 100))

    hash1 = dHash(img1)
    hash2 = dHash(img2)
    n2 = cmpHash(hash1, hash2)
    # print('差值哈希算法相似度dHash：', n2)
    print("使用差值哈希算法得出的相似度: " + '%.2f%%' % ((1 - float(n2 / 64)) * 100))
...
if __name__ == "__main__":
    p1 = "C:/Users/ZCZ/Desktop/frog/tuchong-frog/100.jpg"
    p2 = "C:/Users/ZCZ/Desktop/frog/tuchong-frog/452.jpg"
